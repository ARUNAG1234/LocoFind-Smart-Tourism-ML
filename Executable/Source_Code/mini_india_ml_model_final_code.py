...
bars = plt.bar(modules, accuracies, color='lightgreen', edgecolor='black')
plt.title("Accuracy of LocoFind Modules - Bar Graph")
plt.xlabel("Modules")
plt.ylabel("Accuracy (%)")
plt.ylim(85, 102)
...
plt.figure(figsize=(8,5))
plt.plot(modules, accuracies, marker='o', linestyle='-', color='blue', linewidth=2)
plt.title("Accuracy of LocoFind Modules - Line Graph")
plt.xlabel("Modules")
plt.ylabel("Accuracy (%)")
plt.ylim(85, 102)
plt.xticks(rotation=25)
...
# Add accuracy values on each point
...
# Print table
print("\n***** LocoFind Modules: Best Algorithm Performance *****\n")
...
final_melted = final_results.melt(id_vars=['Module','Best Algorithm'],
                                  value_vars=['R² / Accuracy (%)', 'Precision (%)', 'Recall (%)', 'F1-Score (%)'],
                                  var_name='Metric', value_name='Value')

plt.figure(figsize=(12,6))
sns.barplot(data=final_melted, x='Module', y='Value', hue='Metric')
plt.title("LocoFind Modules: Best Algorithm Performance")
plt.ylabel("Score (%)")
